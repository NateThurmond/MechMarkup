...
<html>
    <head>
        <title>Mech Markup View 4</title>
    ...
    <body>
        ...
        <div id='floatBar'>
            ...
            <div id='menuBar'>
                ...
                <!-- View 4 -->
                <div class="tabContainer">
                    <div class="viewTitle" id="view4_" style="color: yellow;">View 4</div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calcZoomScope(passedX, passedY) {
                ...
                else if ((calcX < (pdfWidth * 0.35)) && (calcY < (pdfHeight * 0.47))) {
                    zoomArea = "weaponArea";
                }
            ...
            function calcXY(clientX, clientY, halfPageWidth, halfPageHeight, marginTop, zoomModeActive) {
                ...
                if (zoomModeActive) {
                    if (clientX > halfPageWidth) {
                        // Here is the calculation for crit area offset
                        ...
                        //offsetX = halfPageWidth + ((clientX - halfPageWidth) / 1.65);
                    }
                    else {
                        // Here is the calculation for crit area offset
                        ...
                        //offsetX = halfPageWidth - ((halfPageWidth - clientX) / 1.65);
                    }
                    ...
                    if (clientY > halfPageHeight) {
                        ...
                        //offsetY = halfPageHeight + ((clientY - halfPageHeight) / 1.65) - (marginTop);
                    }
                    else {
                        // Here is the calculation for crit area offset
                        ...
                        //offsetY = halfPageHeight - ((halfPageHeight - clientY) / 1.65) - (marginTop);
                    }
                }
